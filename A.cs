...
namespace Library
{
    public partial class A : Form
    {
        ...
        public bool form_active4 = false;
        ...
        private void A_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Seats where Seats LIKE 'A%'", baglanti);
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd4 = new SqlCommand("dbo.Get_Full_A", baglanti);
